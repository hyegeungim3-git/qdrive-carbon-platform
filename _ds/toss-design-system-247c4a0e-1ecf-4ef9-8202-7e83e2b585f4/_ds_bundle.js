/* @ds-bundle: {"format":3,"namespace":"TossDesignSystem_247c4a","components":[{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Badge","sourcePath":"components/data/Badge.jsx"},{"name":"Card","sourcePath":"components/data/Card.jsx"},{"name":"Table","sourcePath":"components/data/Table.jsx"},{"name":"Dialog","sourcePath":"components/feedback/Dialog.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Toggle","sourcePath":"components/forms/Toggle.jsx"},{"name":"Tabs","sourcePath":"components/navigation/Tabs.jsx"}],"sourceHashes":{"components/core/Button.jsx":"a1e5422cfbcf","components/data/Badge.jsx":"aeaab1eaf36c","components/data/Card.jsx":"7d7d01a601fc","components/data/Table.jsx":"24c39d08636b","components/feedback/Dialog.jsx":"8beb9e68611c","components/forms/Input.jsx":"5dfec57493de","components/forms/Toggle.jsx":"1c7c3e3adbee","components/navigation/Tabs.jsx":"f20f2a366897","decks/deck-stage.js":"208980974db4","ui_kits/toss-app/HomeScreen.jsx":"8b111d706917","ui_kits/toss-app/PhoneApp.jsx":"49e1362e6e0d","ui_kits/toss-app/SuccessScreen.jsx":"df9558f36e23","ui_kits/toss-app/TransferScreen.jsx":"65dd4e56664e","ui_kits/toss-app/icons.jsx":"071b26606663"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.TossDesignSystem_247c4a = window.TossDesignSystem_247c4a || {});
...
/**
 * Toss Button — variant × color × size.
 * variant: "fill" | "weak"   color: "primary" | "dark" | "danger" | "light"
...
function Button({
  ...
  const s = sizes[size] || sizes.xlarge;
  const c = (palette[variant] || palette.fill)[color] || palette.fill.primary;
  const base = {
    ...
    whiteSpace: "nowrap",
    transition: "filter var(--motion-fast) var(--ease-standard), opacity var(--motion-fast) var(--ease-standard)",
    userSelect: "none",
    ...style
  };
  const dot = {
    ...
    borderRadius: "50%",
    background: c.fg,
    animation: "tdsBtnPulse 1s infinite ease-in-out"
  };
  ...
  }, /*#__PURE__*/React.createElement("style", null, "@keyframes tdsBtnPulse{0%,80%,100%{opacity:.3}40%{opacity:1}}"), /*#__PURE__*/React.createElement("span", {
    style: {
      ...dot,
      animationDelay: "0ms"
    }
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Toss Badge — variant × color × size.
 * variant: "fill" | "weak"
 * color: "blue" | "green" | "red" | "yellow" | "teal" | "elephant"
...
function Badge({
  ...
  const c = (variant === "weak" ? weak : fill)[color] || fill.blue;
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Toss Card surface. variant: "standard" (shadow), "featured" (bigger),
 * "compact" (1px border, no shadow).
 */
function Card({
  children,
  variant = "standard",
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Toss Table — clean financial data table. Tabular numerals on numeric
 * columns. columns: [{ key, label, align, numeric }]. rows: array of objects.
 */
function Table({
  columns = [],
  rows = [],
  ...
  return /*#__PURE__*/React.createElement("table", _extends({
    ...
    style: {
      ...
      color: col.numeric ? "var(--text-strong)" : "var(--text-body)",
      borderBottom: "1px solid var(--divider)",
      fontVariantNumeric: col.numeric ? "tabular-nums" : "normal",
      fontFeatureSettings: col.numeric ? '"tnum" 1' : "normal"
    }
  }, row[col.key]))))));
}
...
/**
 * Toss Dialog — centered modal (default) or bottom sheet. Renders an overlay
 * scrim + panel. Controlled via `open` / `onClose`.
 */
function Dialog({
  open = false,
  onClose,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      justifyContent: "center",
      zIndex: 1000,
      animation: "tdsFade var(--motion-standard) var(--ease-enter)"
    }
  }, /*#__PURE__*/React.createElement("style", null, "@keyframes tdsFade{from{opacity:0}to{opacity:1}}@keyframes tdsRise{from{transform:translateY(40px)}to{transform:translateY(0)}}"), /*#__PURE__*/React.createElement("div", {
    onClick: e => e.stopPropagation(),
    style: {
      background: "var(--float-background)",
      width: isSheet ? "100%" : "min(360px, calc(100% - 40px))",
      maxWidth: isSheet ? 460 : 360,
      borderRadius: isSheet ? "16px 16px 0 0" : 16,
      padding: isSheet ? "24px 20px" : 24,
      boxShadow: isSheet ? "var(--shadow-sheet)" : "var(--shadow-elevated)",
      animation: isSheet ? "tdsRise var(--motion-standard) var(--ease-enter)" : "none",
      ...style
    }
  }, isSheet && /*#__PURE__*/React.createElement("div", {
    style: {
      width: 40,
      height: 4,
      borderRadius: 2,
...
/**
 * Toss TextField — variants: "box" (default), "line", "big", "hero".
 * hasError toggles the error treatment. Supports label + helper text.
 */
function Input({
  variant = "box",
  hasError = false,
  ...
  const variants = {
    box: {
      ...
      border: `1px solid ${hasError ? "var(--red-500)" : focused ? "var(--blue-500)" : "rgba(2,32,71,0.05)"}`,
      borderRadius: 14,
      padding: "14px 16px",
      fontSize: 17,
      fontWeight: 400
    ...
    line: {
      ...
      border: "none",
      borderBottom: `1px solid ${hasError ? "var(--red-500)" : focused ? "var(--blue-500)" : "var(--grey-200)"}`,
      borderRadius: 0,
      padding: "0 0 6px",
      fontSize: 17,
      fontWeight: 400
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      fontSize: 13,
      color: hasError ? "var(--red-500)" : "var(--text-secondary)"
    }
  }, helper));
}
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Toss Toggle — boolean switch. Blue when on, grey when off; white thumb.
 */
function Toggle({
  checked = false,
  onChange,
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Toss Tabs — variant: "segmented" (default) or "underline".
...
// ui_kits/toss-app/HomeScreen.jsx
try { (() => {
/* Toss app — Home (자산) screen. White surfaces on grey section bg. */
function HomeScreen({
  onTransfer
}) {
  const {
    Card,
    Badge
  } = window.TossDesignSystem_247c4a;
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uB0B4 \uC790\uC0B0")), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "8px 20px"
    }
  ...
  }, "\uD1A0\uC2A4\uBC45\uD06C \uD1B5\uC7A5"), /*#__PURE__*/React.createElement("div", {
    className: "tnum",
    style: {
      fontSize: 24,
      fontWeight: 700,
  ...
  }, "1,240,000", /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 16,
      fontWeight: 400
    }
  }, "\uC6D0"))), /*#__PURE__*/React.createElement(Icon, {
    name: "chevron-right",
    size: 22,
    color: "var(--grey-400)"
  ...
  }, "\uC1A1\uAE08\uD558\uAE30"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between",
      padding: "12px 28px 4px"
    }
  }, quickActions.map(q => /*#__PURE__*/React.createElement("div", {
    key: q.name,
    style: {
      display: "flex",
      flexDirection: "column",
    ...
    onClick: q.name === "송금" ? onTransfer : undefined
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      width: 52,
      height: 52,
    ...
    color: "blue",
    size: "small"
  }, "\uD61C\uD0DD"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 17,
      fontWeight: 700,
      color: "var(--text-strong)",
  ...
  }, "\uD1A0\uC2A4\uBC45\uD06C \uC801\uAE08 \uC5F0 5.0%"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "var(--text-body)",
      marginTop: 4
    }
  }, "\uC9C0\uAE08 \uAC00\uC785\uD558\uBA74 \uC6B0\uB300\uAE08\uB9AC\uB97C \uB4DC\uB824\uC694.")), /*#__PURE__*/React.createElement(Icon, {
    name: "piggy-bank",
    size: 40,
    color: "var(--blue-500)"
  })))), /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uCD5C\uADFC \uAC70\uB798"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      color: "var(--text-secondary)"
    }
    ...
    style: {
      fontSize: 15,
      fontWeight: 600,
      color: t.income ? "var(--positive)" : "var(--text-strong)"
    }
  }, t.amt, "\uC6D0")))));
}
window.HomeScreen = HomeScreen;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/toss-app/HomeScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/toss-app/PhoneApp.jsx
try { (() => {
/* Toss app — orchestrator: phone frame, screen routing, bottom tab bar. */
function BottomTab({
  active
}) {
  const Icon = window.Icon;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      name: t.icon,
      size: 24,
      color: on ? "var(--blue-500)" : "var(--grey-400)"
    }), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 11,
        fontWeight: 500,
...
function PhoneApp() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      fontWeight: 600,
      color: "var(--grey-900)",
      background: screen === "transfer" || screen === "success" ? "#fff" : "var(--grey-100)"
    }
  ...
  }), screen === "transfer" && /*#__PURE__*/React.createElement(window.TransferScreen, {
  ...
  })), screen === "home" && /*#__PURE__*/React.createElement(BottomTab, {
    active: "home"
  }))));
}
window.PhoneApp = PhoneApp;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/toss-app/PhoneApp.jsx", error: String((e && e.message) || e) }); }

// ui_kits/toss-app/SuccessScreen.jsx
try { (() => {
/* Toss app — money-moved Success screen. Dedicated screen, never a toast.
   Green checkmark drawn with spring easing (the one licensed place). */
function SuccessScreen({
  ...
  }, /*#__PURE__*/React.createElement("style", null, "@keyframes tdsCheckPop{0%{transform:scale(0)}100%{transform:scale(1)}}"), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 72,
      height: 72,
      borderRadius: "50%",
      ...
      alignItems: "center",
      justifyContent: "center",
      animation: "tdsCheckPop var(--motion-slow) var(--ease-spring)"
    }
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "check",
    size: 40,
  ...
  }, "\uC1A1\uAE08\uC774 \uC644\uB8CC\uB418\uC5C8\uC5B4\uC694"), /*#__PURE__*/React.createElement("div", {
    className: "tnum",
    style: {
      fontSize: 30,
      fontWeight: 700,
  ...
  }, "\uAE40\uBBFC\uC218 \uB2D8\uC5D0\uAC8C \uBCF4\uB0C8\uC5B4\uC694"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "var(--text-secondary)",
      marginTop: 4
    }
  }, "2026.06.20 \uC624\uD6C4 3:42"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: 20,
      right: 20,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/toss-app/SuccessScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/toss-app/TransferScreen.jsx
try { (() => {
/* Toss app — Transfer (송금) screen. Hero amount input + numeric keypad +
   sticky bottom CTA. One action per screen. */
function TransferScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uAE40\uBBFC\uC218"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "var(--text-secondary)"
    }
  }, "\uD1A0\uC2A4\uBC45\uD06C 1001-23-456789"))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      color: "var(--text-body)",
      marginBottom: 8
    ...
    style: {
      fontSize: 34,
      fontWeight: 700,
      color: valid ? "var(--text-strong)" : "var(--text-placeholder)",
      borderBottom: "2px solid " + (valid ? "var(--blue-500)" : "var(--grey-200)"),
      paddingBottom: 10
    }
  }, valid ? fmt(amount) : "0", /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 24,
      fontWeight: 400
    }
  ...
  }, "\uCD9C\uAE08 \uAC00\uB2A5 \uAE08\uC561 1,240,000\uC6D0")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, valid ? fmt(amount) + "원 보내기" : "송금하기")));
}
window.TransferScreen = TransferScreen;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/toss-app/TransferScreen.jsx", error: String((e && e.message) || e) }); }

// ui_kits/toss-app/icons.jsx
try { (() => {
/* Lucide icon helper. Renders <i data-lucide> and upgrades to SVG after render.
   Size + color come from the wrapping span (stroke inherits currentColor). */
function Icon({
  name,
  size = 24,
  color = "currentColor",
...
window.Icon = Icon;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/toss-app/icons.jsx", error: String((e && e.message) || e) }); }
